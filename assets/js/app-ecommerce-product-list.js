document.addEventListener("DOMContentLoaded", function (e) {
  ...
  let t = document.querySelector(".datatables-products"),
    ...
    r = { 0: { title: "Out_of_Stock" }, 1: { title: "In_Stock" } };
  t &&
    new DataTable(t, {
            ...
            return `
              <div class="d-flex justify-content-start align-items-center product-name">
                <div class="avatar-wrapper">
                  <div class="avatar avatar me-2 me-sm-4 rounded-2 bg-label-secondary">${(c =
                    r
                      ? `<img src="${assetsPath}img/ecommerce-images/${r}" alt="Product-${n.id}" class="rounded">`
                        ...
                        format: {
                          body: function (e, t, n) {
                              ...
                              return e;
                            {
                              ...
                              let t = "";
                              var a = e.querySelectorAll(".product-name");
                              return (
                                0 < a.length
                                  ? a.forEach((e) => {
                                      e =
                          ...
                          body: function (e, t, n) {
                            ...
                            return (
                              0 < o.length
                                ...
                                : (a = e.body.textContent || e.body.innerText),
                              a.trim()
                            );
                          },
                        },
        ...
        details: {
          ...
          renderer: function (e, t, n) {
            ...
            return (
              ...
              ((s = document.createElement("tbody")).innerHTML = n),
              o.appendChild(s),
              a)
            );
          },
      ...
      initComplete: function () {
        ...
        e.columns(-2).every(function () {
          ...
          (n.id = "ProductStatus"),
            ...
            (n.innerHTML = '<option value="">Status</option>'),
          ...
          e.columns(4).every(function () {
            ...
            (n.id = "ProductStock"),
              (n.className = "form-select text-capitalize"),
              (n.innerHTML = '<option value="">Stock</option>'),
